...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='author',
            name='year_of_birth',
            field=models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(2024, message='Year of birth cannot be greater than current year')]),
        ),
        migrations.AlterField(
            model_name='author',
            name='year_of_death',
